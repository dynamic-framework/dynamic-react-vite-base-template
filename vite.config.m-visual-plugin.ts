 ...
 *
 * Construye .perf/widget-entry-visual.tsx como un bundle único `widget.js` con los
...
export default defineConfig({
  ...
  build: {
    outDir: 'dist-m-harness',
    cssCodeSplit: false,
    chunkSizeWarningLimit: 2000,
    minify: 'esbuild',
    assetsDir: '',
    rollupOptions: {
      input: path.resolve(__dirname, '.perf/widget-entry-visual.tsx'),
      output: {
